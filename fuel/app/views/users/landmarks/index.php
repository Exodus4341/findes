...
<?php foreach ($landmarks as $landmark): ?>		<tr>
			...
			<td style="padding-bottom:20px;">
				...
				<p style="margin-top:-20px; width:500px;"><i><?php echo $landmark->description; ?></i></p>
					...
					<div class="span4">
						<div><?php echo Html::anchor('users/landmarks/view/'.$landmark->slug, Html::img('uploads/landmarks/'.$landmark->placename.'/thumb/'.$landmark->fileurl,array('class' => 'image')));?></div>
					</div>
			</td>
			<td><?php $numrates = 0; 
