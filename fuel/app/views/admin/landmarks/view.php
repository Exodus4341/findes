		...
		<div class="row" style="width:500px; float:left">
			<div class="span4" id="c-img">
					<div class="inner-cont">
						<p style="font-size: 23px; border-bottom:1px groove gray; padding-top:5px; width:450px;"><b><?php echo $landmark->placename;?></b></p>
			...
			<div class="span4" id="c-img" style="margin-top:15px">
				<div class="t-name"><p>Landmark Photos</p></div>
				<div class = "inner-cont">
				<p>
			...
			<div class="span4" id="c-img" style="margin-top:15px">
				<div class="t-name"><p>Comments</p></div>
					...
					<?php foreach ($landmark->comments as $comment): ?>
					   ...
					   <div style="float:left;"><?php echo Html::img('assets/img/gravatar.png',array('class' => 'img-thumbnail')); ?></div>
		 	...
		 	<div class="span4" id="c-img" style="margin-top:15px">
				<div class="t-name"><p>Write a comment</p></div>
					...
					<?php echo Form::open('admin/landmarks/comment/'.$landmark->slug) ?>
					   ...
					   <div class="input"><?php echo Form::textarea('message','',array('class' => 'span5')); ?></div>
...
<script>
		...
		var map = L.map('map').setView(['<?php echo $landmark->latitude; ?>','<?php echo $landmark->longitude; ?>'], 16);
