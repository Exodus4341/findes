<?php echo Form::open(); ?>
	...
	<fieldset>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('password', Input::post('password', isset($user) ? $user->password : ''), array('class' => 'span4', 'type' => 'password')); ?>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('profile_fields', Input::post('profile_fields', isset($user) ? $user->profile_fields : ''), array('class' => 'span8', 'type' => 'hidden')); ?>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('active', Input::post('active', isset($user) ? $user->active : ''), array('class' => 'span4', 'type' => 'hidden')); ?>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('type', Input::post('type', isset($user) ? $user->type : ''), array('class' => 'span4', 'type' => 'hidden')); ?>
